...
ALG_NAME = 'AC'
TRAIN_EPISODES = 3000  # number of overall episodes for training
    ...
    if args.train:
        ...
        for episode in range(TRAIN_EPISODES):
            ...
            while True:
                ...
                try:
                    if episode > 1000 and random.randint(1, 100) > 90:
        ...
        np.savetxt("SmDisoR training.txt", all_episode_reward, fmt="%.14f")
