...
#####################  hyper parameters  ####################
#CartPole-v2是状态重复 CartPole-v3是状态突变
...
if __name__ == '__main__':
    ...
    if args.train:
        ...
        for episode in range(TRAIN_EPISODES):
            ...
            while True:
                ...
                if random.randint(1,100) > 90:
                    data = (random.uniform(-4,4), random.uniform(-2.1339755, 2.5335634), random.uniform(-0.418, 0.418), random.uniform(-2.7922547, 2.9268053) )
        ...
        np.savetxt("StDisoP reward.txt", all_episode_reward, fmt="%.14f")
