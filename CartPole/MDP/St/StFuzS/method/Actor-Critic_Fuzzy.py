    ...
    if args.train:
        ...
        for episode in range(TRAIN_EPISODES):
            ...
            while True:
                ...
                state_new = [format(state_new[0], '.4f'), format(state_new[1], '.4f'), format(state_new[2], '.4f'), format(state_new[3], '.4f')]
        ...
        np.savetxt("StFuzS training.txt", all_episode_reward, fmt="%.14f")
