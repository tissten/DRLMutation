...
if __name__ == '__main__':
    ...
    if args.train:
        ...
        for episode in range(TRAIN_EPISODES):
            ...
            state_new, pre_reward, done, info = env.step(action)
            while True:
        ...
        #print("all_episode_reward is:", all_episode_reward)
        np.savetxt("ReRepR reward.txt", all_episode_reward, fmt="%.14f")
