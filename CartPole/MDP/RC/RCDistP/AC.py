...
class Critic(object):
    ...
    def learn(self, state, reward, state_, LAM, done):
        d = 0 if done else 1
    ...
    if args.train:
        ...
        for episode in range(TRAIN_EPISODES):
            ...
            while True:
                ...
                if flag % 10 ==0:
                    LAM = 0.9 + random.uniform(-0.1, 0.1)
                else:
                    LAM = 0.9
                ...
                try:
                    td_error = critic.learn(
                        state, reward, state_new, LAM, done
        ...
        np.savetxt("RcDistP training.txt", all_episode_reward, fmt="%.14f")
