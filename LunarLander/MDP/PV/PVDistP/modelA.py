...
class ActorCritic(nn.Module):
    ...
    def forward(self, state,flag = False):
        ...
        if flag:
            ...
            modified_action_probs[0] += random.uniform(-modified_action_probs[0]/2, (all_probs-modified_action_probs[0])/2)
            all_probs -= modified_action_probs[0]

            modified_action_probs[1] += random.uniform(-modified_action_probs[1]/2, (all_probs-modified_action_probs[1])/2)
            all_probs -= modified_action_probs[1]

            modified_action_probs[2] += random.uniform(-modified_action_probs[2]/2, (all_probs-modified_action_probs[2])/2)
