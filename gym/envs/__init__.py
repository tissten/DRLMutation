...
register(
    id='CartPole-v2',
    entry_point='gym.envs.classic_control:CartPoleEnvTest1',
    max_episode_steps=200,
    reward_threshold=195.0,
)
...
register(
    id='CartPole-v3',
    entry_point='gym.envs.classic_control:CartPoleEnvTest2',
    max_episode_steps=200,
    reward_threshold=195.0,
)
...
register(
    id='CartPole-v4',
    entry_point='gym.envs.classic_control:CartPoleEnvTest3',
    max_episode_steps=200,
    reward_threshold=195.0,
)
...
register(
    ...
    entry_point='gym.envs.classic_control:Continuous_MountainCarEnvTest1',
    max_episode_steps=999,
    reward_threshold=90.0,
)
...
register(
    ...
    entry_point='gym.envs.classic_control:Continuous_MountainCarEnvTest2',
    max_episode_steps=999,
    reward_threshold=90.0,
)
