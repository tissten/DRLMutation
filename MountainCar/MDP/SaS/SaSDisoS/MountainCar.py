...
############# Training 模型训练        ##################################################
        ...
        for i_episode in range(num_updates):
            ...
            for timestep in range(num_steps):
                ...
                # if i % 10 ==0:
                #     obs_t = pre_obs_t
                #     recurrent_hidden_states = pre_recurrent_hidden_states
                #     actions = pre_actions
                #     action_log_prob = pre_action_log_prob
                #     value = pre_value
                #     rewards_t = pre_rewards_t
                #     masks = pre_masks
                    # print("1")
...
##############       Training模型保存     ###############################################################
        ...
        np.savetxt("SmDisoS training.txt", scores_array, fmt="%.14f")
