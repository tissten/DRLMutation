...
from deep_rl_zoo import gym_env_state_di_r
...
flags.DEFINE_string('tag', '_state_dist_r_f', 'Add tag to Tensorboard log file.')
...
flags.DEFINE_string('mutation_dimensions','_dist_r_f','mutation_object')
...
def main(argv):
    ...
    def environment_builder():
        return gym_env_state_di_r.create_atari_environment(
