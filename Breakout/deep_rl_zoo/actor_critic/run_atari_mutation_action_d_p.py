...
from deep_rl_zoo.actor_critic import agent_action_d_p
...
flags.DEFINE_string('tag', '_action_d_p_f', 'Add tag to Tensorboard log file.')
...
flags.DEFINE_string('mutation_dimensions','_d_p_f','mutation_object')
...
def main(argv):
    ...
    train_agent = agent_action_d_p.ActorCritic(
