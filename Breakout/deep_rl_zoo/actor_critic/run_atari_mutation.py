...
flags.DEFINE_string('tag', '_benti_n', 'Add tag to Tensorboard log file.')
flags.DEFINE_string('results_csv_path', './logs/actor_critic_atari_results.csv', 'Path for CSV log file.')
flags.DEFINE_string('checkpoint_dir', './chekpoints', 'Path for checkpoint directory.')
flags.DEFINE_string('mutation_object','_benti','muatation_object')
flags.DEFINE_string('mutation_dimensions','_NO','muatation_object')
