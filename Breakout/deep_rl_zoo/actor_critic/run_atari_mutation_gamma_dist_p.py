...
from deep_rl_zoo.actor_critic import agent_gamma_di_p
from deep_rl_zoo.checkpoint import PyTorchCheckpoint
from deep_rl_zoo import main_loop
#from deep_rl_zoo import gym_env
from deep_rl_zoo import greedy_actors
from deep_rl_zoo import replay as replay_lib
from deep_rl_zoo import gym_env_mutation
...
flags.DEFINE_string('tag', '_gamma_di_p_n', 'Add tag to Tensorboard log file.')
flags.DEFINE_string('results_csv_path', './logs/actor_critic_action_p.csv', 'Path for CSV log file.')
flags.DEFINE_string('checkpoint_dir', './gamma', 'Path for checkpoint directory.')
flags.DEFINE_string('mutation_object','gamma','mutation_object')
flags.DEFINE_string('mutation_dimensions','_di_P_n','mutation_object')
flags.DEFINE_string('load_checkpoint_file', 'action/Actor-Criticgamma_di_P_Breakout_12.ckpt', 'Load a specific checkpoint file.')
...
def main(argv):
    ...
    def environment_builder():
        return gym_env_mutation.create_atari_environment(
    ...
    train_agent = agent_gamma_di_p.ActorCritic(
