...
from deep_rl_zoo import gym_env_mutation_r_r_p
FLAGS = flags.FLAGS
...
flags.DEFINE_string('tag', '_reward_r_p_f', 'Add tag to Tensorboard log file.')
...
def main(argv):
    ...
    def environment_builder():
        return gym_env_mutation_r_r_p.create_atari_environment(
