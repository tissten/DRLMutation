...
from deep_rl_zoo import gym_env_mutation_state_f_p
...
flags.DEFINE_string('tag', '_state_f_p_f', 'Add tag to Tensorboard log file.')
...
flags.DEFINE_string('mutation_dimensions','_f_P_f','mutation_object')
...
def main(argv):
    ...
    def environment_builder():
        return gym_env_mutation_state_f_p.create_atari_environment(
