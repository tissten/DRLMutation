...
from deep_rl_zoo import gym_env_mutation_r_di_r
FLAGS = flags.FLAGS
...
flags.DEFINE_string('tag', '_reward_di_r_f', 'Add tag to Tensorboard log file.')
...
flags.DEFINE_string('mutation_dimensions','_di_r_f','mutation_object')
...
def main(argv):
    ...
    def environment_builder():
        return gym_env_mutation_r_di_r.create_atari_environment(
