...
from deep_rl_zoo import gym_env_mutation_r_di_s
FLAGS = flags.FLAGS
...
flags.DEFINE_string('tag', '_reward_di_s_f', 'Add tag to Tensorboard log file.')
...
def main(argv):
    ...
    def environment_builder():
        return gym_env_mutation_r_di_s.create_atari_environment(
