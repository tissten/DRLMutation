...
flags.DEFINE_string('tag', '_cea', 'Add tag to Tensorboard log file.')
flags.DEFINE_string('results_csv_path', './logs/actor_critic_reward_atari_results.csv', 'Path for CSV log file.')
...
flags.DEFINE_string('mutation_dimensions','_ce','muatation_object')
