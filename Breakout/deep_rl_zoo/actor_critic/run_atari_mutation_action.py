...
from deep_rl_zoo.actor_critic import agent_action_p
...
flags.DEFINE_string('tag', '_action_r_p_c', 'Add tag to Tensorboard log file.')
...
flags.DEFINE_string('mutation_dimensions','_r_P_c','mutation_object')
...
def main(argv):
    ...
    train_agent = agent_action_p.ActorCritic(
