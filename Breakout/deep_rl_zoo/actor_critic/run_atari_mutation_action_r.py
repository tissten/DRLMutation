...
from deep_rl_zoo.actor_critic import agent_action_r_r
...
flags.DEFINE_string('tag', '_action_r_r_f', 'Add tag to Tensorboard log file.')
...
flags.DEFINE_string('mutation_object','action','mutation_object')
flags.DEFINE_string('mutation_dimensions','_r_r_f','mutation_object')
...
def main(argv):
    ...
    train_agent = agent_action_r_r.ActorCritic(
