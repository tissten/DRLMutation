...
from deep_rl_zoo import gym_env_mutation_r_di_p
FLAGS = flags.FLAGS
...
flags.DEFINE_string('tag', '_reward_di_p_f', 'Add tag to Tensorboard log file.')
flags.DEFINE_string('results_csv_path', './logs/actor_critic_action_p.csv', 'Path for CSV log file.')
flags.DEFINE_string('checkpoint_dir', './reward', 'Path for checkpoint directory.')
flags.DEFINE_string('mutation_object','reward','mutation_object')
flags.DEFINE_string('mutation_dimensions','_di_p_f','mutation_object')
...
def main(argv):
    ...
    def environment_builder():
        return gym_env_mutation_r_di_p.create_atari_environment(
    ...
    FLAGS.tag=FLAGS.mutation_dimensions
    # Setup checkpoint.
    a_name = 'Actor-Critic'+ FLAGS.mutation_dimensions
