...
from deep_rl_zoo import gym_env_mutation_r_r_r
FLAGS = flags.FLAGS
...
flags.DEFINE_string('tag', '_reward_r_r_f', 'Add tag to Tensorboard log file.')
...
flags.DEFINE_string('mutation_dimensions','_r_rr_f','mutation_object')
...
def main(argv):
    ...
    def environment_builder():
        return gym_env_mutation_r_r_r.create_atari_environment(
