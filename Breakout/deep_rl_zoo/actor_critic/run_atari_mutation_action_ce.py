...
flags.DEFINE_string('tag', '_ce_ce', 'Add tag to Tensorboard log file.')
flags.DEFINE_string('results_csv_path', './logs/actor_critic_action_p.csv', 'Path for CSV log file.')
flags.DEFINE_string('checkpoint_dir', './action', 'Path for checkpoint directory.')
flags.DEFINE_string('mutation_object','1','mutation_object')
flags.DEFINE_string('mutation_dimensions','_ce','mutation_object')
flags.DEFINE_string('load_checkpoint_file', 'checkpoints/Actor-Critic_Breakout_8.ckpt', 'Load a specific checkpoint file.')
