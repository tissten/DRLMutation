...
from deep_rl_zoo.actor_critic import agent_gamma_rem_p
...
flags.DEFINE_string('tag', '_gamma_rem_p_n', 'Add tag to Tensorboard log file.')
...
flags.DEFINE_string('mutation_dimensions','_rem_P_n','mutation_object')
...
def main(argv):
    ...
    train_agent = agent_gamma_rem_p.ActorCritic(
