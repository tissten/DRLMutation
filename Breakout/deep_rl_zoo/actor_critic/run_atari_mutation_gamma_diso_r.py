...
from deep_rl_zoo.actor_critic import agent_gamma_d_r
...
flags.DEFINE_string('tag', '_gamma_d_r', 'Add tag to Tensorboard log file.')
...
flags.DEFINE_string('mutation_dimensions','_d_r','mutation_object')
...
def main(argv):
    ...
    train_agent = agent_gamma_d_r.ActorCritic(
