...
from deep_rl_zoo.actor_critic import agent_gamma_di_r
...
flags.DEFINE_string('tag', '_gamma_di_r_n', 'Add tag to Tensorboard log file.')
...
flags.DEFINE_string('mutation_dimensions','_di_r_n','mutation_object')
...
def main(argv):
    ...
    train_agent = agent_gamma_di_r.ActorCritic(
