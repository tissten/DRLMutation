...
from deep_rl_zoo import gym_env_mutation_r_d_r
FLAGS = flags.FLAGS
...
flags.DEFINE_string('tag', '_reward_d_r_f', 'Add tag to Tensorboard log file.')
...
flags.DEFINE_string('mutation_dimensions','_d_r_f','mutation_object')
...
def main(argv):
    ...
    def environment_builder():
        return gym_env_mutation_r_d_r.create_atari_environment(
