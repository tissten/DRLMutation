...
flags.DEFINE_string('tag', '_gamma_d_p_n', 'Add tag to Tensorboard log file.')
...
flags.DEFINE_string('mutation_dimensions','_d_P_n','mutation_object')
...
def main(argv):
    ...
    train_agent = agent_gamma_d_p.ActorCritic(
